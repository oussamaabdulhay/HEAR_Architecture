...
Matrix3by3::Matrix3by3(Vector3D<float> t_v1, Vector3D<float> t_v2, Vector3D<float> t_v3) {
    v1 = t_v1;
    v2 = t_v2;
    v3 = t_v3;
}

Vector3D<float> Matrix3by3::TransformVector(Vector3D<float> t_input) {
