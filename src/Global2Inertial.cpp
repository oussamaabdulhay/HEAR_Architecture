...
Global2Inertial::Global2Inertial() {
    ...
    _input_port_3 = new InputPort(ports_id::IP_3_XSESN_POS, this);
    _input_port_4 = new InputPort(ports_id::IP_4_XSESN_VEL, this);
    _input_port_5 = new InputPort(ports_id::IP_5_XSESN_ORI, this);
...
void Global2Inertial::process(DataMsg* t_msg, Port* t_port)
{
    if(t_port->getID() == ports_id::IP_0_OPTI_MSG){ 
        ...
        // //Vector3D<double> results=offsetElevation(results,-calib_point1.z);
    ...
    else if (t_port->getID() == ports_id::IP_3_XSESN_POS){
        // Vector3D<double> results = changeLLAtoMeters(calib_point1,((Vector3DMsg*)t_msg)->data);
        // Vector3D<double> results_rot=rotatePoint(results);
        // Vector3DMsg res_msg;
        // res_msg.data = results_rot;
