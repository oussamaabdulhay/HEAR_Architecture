...
RotationMatrix3by3_camera::RotationMatrix3by3_camera(/* args */) : _m(3,3){
    
}

RotationMatrix3by3_camera::~RotationMatrix3by3_camera(){
}

Eigen::MatrixXd RotationMatrix3by3_camera::Update(Vector3D<float> t_input)
{ 
